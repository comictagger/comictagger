...
def internal(parser: settngs.Manager) -> None:
    ...
    parser.add_setting("overlay_read_merge_lists", default=True, cmdline=False, action=argparse.BooleanOptionalAction)
    parser.add_setting("overlay_source_merge_lists", default=True, cmdline=False, action=argparse.BooleanOptionalAction)
