...
class IssueIdentifier:
    ...
    def get_issue_cover_match_score(
        ...
        remote_cover_list = [Score(url=primary_img_url, remote_hash=self.calculate_hash(url_image_data))]
        ...
        if use_remote_alternates:
            for alt_url in alt_urls:
                ...
                remote_cover_list.append(Score(url=alt_url, remote_hash=self.calculate_hash(alt_url_image_data)))
        ...
        for local_cover_hash in local_cover_hash_list:
            for remote_cover_item in remote_cover_list:
                score = ImageHasher.hamming_distance(local_cover_hash, remote_cover_item["remote_hash"])
                score_list.append(
                    Score(score=score, url=remote_cover_item["url"], remote_hash=remote_cover_item["remote_hash"])
                )
